...
이 연습에서 사용하는 모든 리소스를 한 구획(Compartment)에서 사용하기 위해, **task** 라는 이름의 컴파트먼트를 생성합니다. 아래 절차에 따릅니다.
...
link:./01_check_service_limit.adoc[이전: 연습 1 - 서비스 한도 확인] |
link:./03_create_vcn.adoc[다음: 연습 3 - VCN 생성]